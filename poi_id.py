...
## The below is an attempt to use SelectKBest.
## Effect is the same as just using PCA.
#from sklearn.feature_selection import SelectKBest
#from sklearn.feature_selection import chi2
#clf = SelectKBest(chi2, k=2).fit(features, labels)
#features_new = clf.transform(features)
#print "Scores: ", clf.scores_
#print "Features new shape: ", features_new.shape
#print "Features new: ", features_new
...
#estimators = [('reduce_dim', PCA(n_components=3)), ('classifier', SVC(kernel='rbf'))] # Precision or recall may be undefined due to a lack of true positive predicitons.
...
#estimators = [('reduce_dim', PCA(n_components=3)), ('classifier', KNeighborsClassifier(n_neighbors=3))] #Accuracy: 0.87220       Precision: 0.53496      Recall: 0.31750 F1: 0.39849     F2: 0.34560
estimators = [('reduce_dim', PCA(n_components=3)), ('classifier', KNeighborsClassifier(n_neighbors=3, p=1))] #Accuracy: 0.88073       Precision: 0.58669      Recall: 0.35700 F1: 0.44389     F2: 0.38733
